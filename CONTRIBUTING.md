# Contributing to poissonreg

This outlines how to propose a change to poissonreg. For more detailed
...
Please note that the poissonreg project is released with a [Contributor
Code of Conduct](https://poissonreg.tidymodels.org/CODE_OF_CONDUCT.md).
